...
import '../core/components/animated_loading_text_widget.dart';
...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void _initController() {
    backgroundController = AnimationController(vsync: this, duration: Duration(seconds: 2));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          RotatorWidget(transitionController: transitionController, assetPath: 'assets/splash_screen/splash_screen_loading.gif'),
